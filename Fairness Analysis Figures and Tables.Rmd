...
table_by_2_dif_quart <- matrix(nrow = 5, ncol = 5)
...
for (j in 1:4) {
  vals <- table_dat %>% 
      filter(`Black Prop. Quartile`==j) 
  table_by_2_dif_quart [5,j] <- round(median(vals$`1 week ahead MAE`),3)
...
for (i in 1:4) {
  vals <- table_dat %>% 
       filter(`Case Quartile`==i)
  table_by_2_dif_quart [i,5] <- round(median(vals$`1 week ahead MAE`),3)
...
\multicolumn{1}{|c|}{\textbf{Case Quartile}} & lowest 25\% & Q2 & Q3 & highest 25\% & Overall \\ \hline
\multicolumn{1}{|c|}{lowest 25\%} & 6.059 & 6.559 & \cellcolor[HTML]{FD6864}7.794 & \cellcolor[HTML]{FD6864}7.632 & 6.647 \\ \hline
\multicolumn{1}{|c|}{Q2} & 14.103 & \cellcolor[HTML]{FFCCC9}14.882 & \cellcolor[HTML]{FD6864}17.706 & \cellcolor[HTML]{FFCCC9}15.147 & 14.912 \\ \hline
\multicolumn{1}{|c|}{Q3} & 25.853 & \cellcolor[HTML]{FFCCC9}29.088 & \cellcolor[HTML]{FD6864}29.603 & 28.912 & 28.515 \\ \hline
\multicolumn{1}{|c|}{highest 25\%} & 79.059 & 73.368 & 91.324 & \cellcolor[HTML]{FFCCC9}111.779 & 93.353 \\ \hline
\multicolumn{1}{|c|}{Overall} & 10.279 & \cellcolor[HTML]{FD6864}19.588 & \cellcolor[HTML]{FD6864}35.618 & \cellcolor[HTML]{FD6864}29.500 & 20.735 \\ \hline
\end{tabular}
...
table_by_2_dif_quart_rmae <- matrix(nrow = 5, ncol = 5)
...
for (i in 1:4) {
  vals <- table_dat_rmae %>% 
       filter(`Case Quartile`==i)
  table_by_2_dif_quart_rmae [i,5] <- 
    round(median(vals$`1 week RMAE`),3)
  
}

table_by_2_dif_quart_rmae [5,5] <- 
...
\multicolumn{1}{l|}{} & \multicolumn{5}{c|}{\textbf{Prop. Black Quartile}} \\ \hline
\multicolumn{1}{|c|}{\textbf{Case Quartile}} & lowest 25\% & Q2 & Q3 & highest 25\% & Overall \\ \hline
\multicolumn{1}{|c|}{lowest 25\%} & 0.898 & 0.901 & 0.910 & 0.885 & 0.898 \\ \hline
\multicolumn{1}{|c|}{Q2} & 0.906 & 0.887 & 0.902 & 0.887 & 0.897 \\ \hline
\multicolumn{1}{|c|}{Q3} & 0.911 & 0.899 & 0.905 & 0.879 & 0.898 \\ \hline
\multicolumn{1}{|c|}{highest 25\%} & 0.923 & 0.890 & 0.889 & 0.894 & 0.891 \\ \hline
\multicolumn{1}{|c|}{Overall} & 0.903 & 0.896 & 0.897 & 0.887 & 0.896 \\ \hline
\end{tabular}
\caption{text}
\label{tab:my-table}
\end{table}
